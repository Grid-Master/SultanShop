...
import { filterGoods, clearGoods } from '../../store/catalogGoodsSlice';
        ...
        <div className='catalog'>
            <div className='container'>
                ...
                <ul className='catalog__hygienelist'>
                    <li onClick={filterHandler}>Уход за телом</li>
                    <li onClick={() => dispatch(clearGoods(3))}>Уход за руками</li>
