...
const Catalog: FC = () => {
  ...
  const pageCount = (): number => {
    if (catalogGoods.length === currentGoods.length) {
      return 1;
    } else {
      return Math.ceil(catalogGoods.length / goodsPerPage);
    }
  };

  console.log(catalogGoods.length, 'catalog');
  console.log(currentGoods.length, 'current');
          ...
          <div>
            ...
            {goods && (
              <ReactPaginate
                ...
                pageCount={Math.ceil(currentGoods.length / (goodsPerPage - 1))}
                previousLabel={' '}
                nextLabel={' '}
