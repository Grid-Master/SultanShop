...
const CardGood: FC = () => {
    ...
    const addGoodToCartHandler = (good: IGood | undefined) => {
        if(good) dispatch(addGood({...good, id: Date.now()}))
    }
                ...
                <div className='cardGood__inner'>
                    ...
                    <div>
                        ...
                        <ul className='cardGood__inner-characteristics'>
                            ...
                            <li>Назначение: <span>{good?.brand}</span></li>
                            <li>Тип: <span>{good?.barcode}</span></li>
                            <li>Производитель: <span>{good?.manufacturer}</span></li>
                            <li>Бренд: <span>{good?.brand}</span></li>
                            <li>Штрихкод: <span>{good?.barcode.slice(0,6)}</span></li>
                            <li>Штрихкод: <span>{good?.barcode}</span></li>
                            <li>Вес: <span>{good?.measureValue}</span></li>
                            <li>Объем: <span>{good?.measureValue}</span></li>
                            <li>Кол-во в коробке: <span>{good?.measureValue}</span></li>
                        </ul>
                    </div>
                </div>
            </div>
