      ...
      <div className="container">
        <div className="cardGood__inner">
          <div className="cardGood__inner-image">
            <button onClick={() => navigate('/SultanShop/catalog')}>
          ...
          <div>
            ...
            <div className="cardGood__inner-container-1">
              ...
              <div>
                ...
                <h4 data-testid="card-good-count">{goodsCount}</h4>
                <button data-testid="increment-count" onClick={() => setGoodsCount(goodsCount + 1)}>
                  +
                </button>
              </div>
