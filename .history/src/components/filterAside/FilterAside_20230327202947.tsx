            ...
            <div className='filter__manufacturer'>
                ...
                <ul id = 'manufacturers'>
                    {manufacturersChecboxMore ? manufacturers.map((manufacturer) => (
                        <li key={manufacturer}>
                            <input className='filter__manufacturer-checkbox' type='checkbox' id={manufacturer} onChange={filterManufacturerHandler} name={manufacturer} />
                    ...
                    manufacturers.slice(0, 4).map((manufacturer) => (
                        <li key={manufacturer}>
                            <input  className='filter__manufacturer-checkbox'  className='filter__manufacturer-checkbox'  type='checkbox' id={manufacturer} onChange={filterManufacturerHandler} name={manufacturer} />
                            <label htmlFor={manufacturer} >{manufacturer}<span>({manufacturerCount(manufacturer)})</span></label>
                        </li>
                    ))
                    }
