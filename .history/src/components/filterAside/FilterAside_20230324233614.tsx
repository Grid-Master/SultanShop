...
import { filterPriceRangeGoods } from '../../store/catalogGoodsSlice';

interface IFilterAsideProp {
    filterHandler: (type:string) => void
}

const FilterAside:FC<IFilterAsideProp> = ({filterHandler}) => {
    const [priceRangeMin, setPriceRangeMin] = useState<number | string>(10)
    const [priceRangeMax, setPriceRangeMax] = useState<number | string>(30)
    ...
    return (
        <aside className='filter'>
            ...
            <p>Цена <span>₸</span></p>
            <div>
                <input type='number' placeholder='0' onChange={filterPriceRangeHandlerMin} />
                <span className='filter-span'>-</span>
                <input type='number' placeholder='10000'  onChange={filterPriceRangeHandlerMax}/>
            </div>
