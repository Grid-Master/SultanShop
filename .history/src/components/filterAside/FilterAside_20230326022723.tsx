...
import { filterGoods, filterManufacturerGoods, filterPriceRangeGoods, reloadGoods } from '../../store/catalogGoodsSlice';
            ...
            <div className='filter__manufacturer'>
                ...
                <ul>
                    {manufacturers.map((manufacturer) => (
                        <li key={manufacturer}>
                            <input type='checkbox' id={manufacturer} onChange={filterManufacturerHandler} name={manufacturer} />
                            <label htmlFor={manufacturer} >{manufacturer}<span>({manufacturerCount(manufacturer)})</span></label>
                        </li>
                    ))}
                    {/* <li>
                        <input type='checkbox' id='check1' onChange={filterManufacturerHandler} name='Grifon' />
                        <label htmlFor='check1' >Grifon<span>(56)</span></label>
                    </li>
                    <li>
                        <input type='checkbox' id='check2' onChange={filterManufacturerHandler} name='Нэфис' />
                        <label htmlFor='check2'>Нэфис<span>(66)</span></label>
                    </li>
                    <li>
                        <input type='checkbox' id='check3' onChange={filterManufacturerHandler} name='Paclan' />
                        <label htmlFor='check3'>Paclan<span>(46)</span></label>
                    </li>
                    <li>
                        <input type='checkbox' id='check4' onChange={filterManufacturerHandler} name='Булгари Грин' />
                        <label htmlFor='check4'>Булгари Грин<span>(21)</span></label>
                    </li>
                    <li>
                        <input type='checkbox' id='check5' onChange={filterManufacturerHandler} name='Softymo' />
                        <label htmlFor='check5'>Softymo<span>(14)</span></label>
                    </li> */}
                </ul>
