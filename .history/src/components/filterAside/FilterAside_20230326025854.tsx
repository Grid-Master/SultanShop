...
const FilterAside:FC<IFilterAsideProp> = ({filterHandler, activeFilter}) => {
    ...
    const filterManufacturerHandler = (e:React.ChangeEvent<HTMLInputElement> | React.ChangeEvent<HTMLInputElement>) => {
        let name: string;
        ...
        <aside className='filter'>
            ...
            <div className='filter__manufacturer'>
                ...
                <div className='filter__manufacturer-container'>
                    <input type='text' placeholder='Поиск...' value={manufacturerSearch} />
                    <button>
                        <img src={search} alt='search' onClick={() =>filterManufacturerHandler} />
                    </button>
                </div>
                <ul>
                    {manufacturersChecboxMore ? manufacturers.map((manufacturer) => (
                        <li key={manufacturer}>
