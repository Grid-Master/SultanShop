      ...
      <div className="panel">
        <div className="container">
          <div className="panel__inner">
            ...
            <button role="price-list" className="panel__inner-pricelist">
              Прайс-лист
              <img src={download} alt="download" />
            </button>
            <div className="panel__inner-cart">
              <img data-testid="cart-link" src={cart} alt="cart" onClick={navigateCartHandler} />
