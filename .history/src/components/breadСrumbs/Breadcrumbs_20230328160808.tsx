        ...
        <div className='breadcrumbs'>
            <div className='container'>
                <div className='breadcrumbs-inner'>
                    <h4>Главная</h4>
                    {path.pathname.split('/').at(1) === 'catalog' ? <h4 onClick={() => navigateHandler('/catalog')}>Каталог</h4> : null }
                    {path.pathname.split('/').at(1) === 'cart' ? <h4 onClick={() => navigateHandler('/cart')}>Корзина</h4> : null }
